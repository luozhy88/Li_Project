...
# Rscript 04_docking_Vina.R  -s "CC(C)CC(NC(=S)Nc1ccccc1)C(=O)NC(CO)CCO" -n 5hie -t input/test1/5hie_modified.pdb 
# Rscript 04_docking_Vina.R  -s "CCC(CCC(C)C1CCC2C1(CCC3C2CC=C4C3(CCC(C4)O)C)C)C(C)C" -n 7Q38 -t input/PDB/7Q38.pdb
# Rscript 04_docking_Vina.R  -s "CC(C)CC(NC(=S)Nc1ccccc1)C(=O)NC(CO)CCO" -n 7Q38 -t input/PDB/7Q38.pdb
...
# mySMILES="OC1=CC=C(C=C1)C1=C(O)C(=O)C2=C(O)C=C(O)C=C2O1"
# mySMILES_name="1P9U"
# target.path="input/test4/1P9U.pdb" #https://www.rcsb.org/structure/8KHF
# Method="Vina"
...
print(paste0("boxCenter: ",boxCenter))
