...
# zhebeim
Filename <- "output/01_TCM_CID_compound_Gene_zhebeimu.csv"
result <- process_tcm_data(Filename, Disease_gene)

# xaikucao
Filename <- "output/01_TCM_CID_compound_Gene_xiakucao.csv"
result <- process_tcm_data(Filename, Disease_gene)
